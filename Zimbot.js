...
body: "GIVE IT A STAR",
mediaType: "VIDEO",
mediaUrl: `https://github.com/Darkside88hacker/zimbot-v4`,
description: 'Darkside Mimo',
previewType: "PHOTO",
...
let picak = picaks[Math.floor(Math.random() * picaks.length)]
 ...
 let chats = global.db.chats[m.chat]
  ...
  if (!('antitelegram' in chats)) chats.antitelegram = true
  if (!('antiinstagram' in chats)) chats.antiinstagram = true
  if (!('antifb' in chats)) chats.antifb = false
  if (!('antibule' in chats)) chats.antibule = false
  if (!('antiwame' in chats)) chats.antiwame = true
...
hydratedButtons:  [{        
    "urlButton": {
      ...
      "url": "https://https://youtube.com/channel/UC4lrNwWgl5VEMeyEQfMmefg"
    }
}, {
quickReplyButton: {
...
if (isCreator) return reply(`*𝘖𝘰𝘰𝘰𝘩 𝘴𝘩𝘪𝘵😩 𝘴𝘰𝘳𝘳𝘺 𝘺𝘶 𝘢𝘳𝘦 𝘵𝘩𝘦 𝘰𝘸𝘯𝘦𝘳 𝘭𝘶𝘤𝘬𝘺 𝘺𝘰𝘶*`)
reply('*ANTI STICKER*\n\n*NO STICKERS  ALLOWED HERE OKAY GOODBYE FOOL YA FOOL*')
kice = m.sender
await ZimBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
...
if (isCreator) return reply(`*𝘖𝘰𝘰𝘰𝘩 𝘴𝘩𝘪𝘵😩 𝘴𝘰𝘳𝘳𝘺 𝘺𝘶 𝘢𝘳𝘦 𝘵𝘩𝘦 𝘰𝘸𝘯𝘦𝘳 𝘭𝘶𝘤𝘬𝘺 𝘺𝘰𝘶*`)
reply('*ANTI VOICE NOTE*\n\n*NO VOICE ALLOWED HERE  OKAY GOODBYE FOOL YA FOOL*')
kice = m.sender
await ZimBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
...
if (isCreator) return reply(`*𝘖𝘰𝘰𝘰𝘩 𝘴𝘩𝘪𝘵😩 𝘴𝘰𝘳𝘳𝘺 𝘺𝘶 𝘢𝘳𝘦 𝘵𝘩𝘦 𝘰𝘸𝘯𝘦𝘳 𝘭𝘶𝘤𝘬𝘺 𝘺𝘰𝘶*`)
reply('*ANTI VIDEO*\n\n*NO VIDEOS ALLOWED HERE  OKAY GOODBYE FOOL YA FOOL*')
kice = m.sender
await ZimBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
...
if (isCreator) return reply(`*𝘖𝘰𝘰𝘰𝘩 𝘴𝘩𝘪𝘵😩 𝘴𝘰𝘳𝘳𝘺 𝘺𝘶 𝘢𝘳𝘦 𝘵𝘩?? 𝘰𝘸𝘯𝘦𝘳 𝘭𝘶𝘤𝘬𝘺 𝘺𝘰𝘶*`)
reply('*ANTI PHOTOS*\n\n*NO PHOTOS ALLOWED HERE  OKAY GOODBYE FOOL YA FOOL*')
kice = m.sender
await ZimBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
...
for (let yoi of anu) {
 ...
 urlButton: {
  displayText: 'GITHUB',
  url: 'https://github.com/Darksisde88hacker/zimbot-v2'
 }
  }, {
 quickReplyButton: {
  displayText: 'OWNER',
...
case 'updatenow':
    ...
    git_url =  git_url.replace("https://", "https://api:dec41246-f923-4dd0-a5ce-48d541f4f092" + Config.HEROKU_API_KEY + "@")//drips
      try {
...
urlButton: {
displayText: `GITHUB`, 
url: `https://github.com/Darkside88hacker/zimbot-v4/fork`
}
}, {
quickReplyButton: {
displayText: `VIDEO`,
...
%readmore` 
    ...
    const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url : `https://https://youtube.com/channel/UC4lrNwWgl5VEMeyEQfMmefg` } }, { urlButton: { displayText: `GITHUB`, url : `https://github.com/Darkside88hacker/zimbot-v4/fork` } },
    {					
      quickReplyButton: {
      displayText: 'SPEED',
      id: 'ping'
